package razor.nikhil.View;

/**
 * Created by Nikhil Verma on 11/12/2015.
 */
...
public class CustomRefresh extends SwipeRefreshLayout implements ViewTreeObserver
    ...
    public void onGlobalLayout() {
        ...
        try {
            ...
            field = SwipeRefreshLayout.class.getDeclaredField("DEFAULT_CIRCLE_TARGET");
            field.setAccessible(true);
            field.setInt(this, 90);
